  ...
  return (
    <form className="space-y-4 rounded-[34px] border border-[#dfe3e8] bg-white p-5 shadow-[0_18px_44px_rgba(0,101,142,0.10)]">
      <label className="block space-y-2">
        <span className="text-sm font-black text-[#171c20]">Deal title</span>
        <input className="h-12 w-full rounded-[20px] border border-[#dfe3e8] bg-[#f6faff] px-4 py-3 text-sm font-semibold outline-none placeholder:text-[#64748b] focus:border-[#229ED9]" placeholder="Landing page redesign" />
      </label>
      <label className="block space-y-2">
        <span className="text-sm font-black text-[#171c20]">Description</span>
        <textarea className="min-h-32 w-full rounded-[20px] border border-[#dfe3e8] bg-[#f6faff] px-4 py-3 text-sm font-semibold outline-none placeholder:text-[#64748b] focus:border-[#229ED9]" placeholder="Scope, acceptance criteria, timeline, revision policy" />
      </label>
      <div className="grid grid-cols-2 gap-3">
        <label className="block space-y-2">
          <span className="text-sm font-black text-[#171c20]">Price</span>
        ...
        <label className="block space-y-2">
          <span className="text-sm font-black text-[#171c20]">Token</span>
      ...
      <label className="block space-y-2">
        <span className="text-sm font-black text-[#171c20]">Deadline</span>
      ...
      <label className="block space-y-2">
        <span className="text-sm font-black text-[#171c20]">Freelancer wallet or Telegram username</span>
        <input className="h-12 w-full rounded-[20px] border border-[#dfe3e8] bg-[#f6faff] px-4 py-3 text-sm font-semibold outline-none placeholder:text-[#64748b] focus:border-[#229ED9]" placeholder="@designer or TON wallet" />
      </label>
